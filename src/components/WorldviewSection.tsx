...
const slides = [
  ...
  },
  {
    ...
    description: "인간이 특정 대상에게 품는 두려움, 혐오 등 부정적인 감정이 뭉쳐져 형상화된 이형의 존재가 바로 주령이다. 바퀴벌레, 화탕지옥, 전염병 등 대중의 공포가 구체적일수록 그 형태와 힘은 기하급수적으로 강해진다. 일반인은 인지할 수 없는 이 저주를 같은 저주인 '주력'을 다루어 제령(除靈)하는 통제자들을 우리는 '주술사'라 부른다.",
