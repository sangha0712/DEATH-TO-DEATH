...
const factions = [
  {
    ...
    sections: [
      { label: "표면적 목적", text: "주술고전과 정부 인력을 통솔하여 온갖 저주와 원령으로부터 무고한 민간인을 절대적으로 보호한다." },
  ...
  },
  {
    ...
    sections: [
      { label: "목적", text: "원령과 인간 사이의 균형이 붕괴되어 원령 쪽으로 힘이 급격히 치우치자, 인류에게 주술은 아직 너무나 이른 힘이라고 판단, 환사유계의 시스템을 이용해 모든 인간으로부터 주력과 주술을 강제로 회수하고자 한다." },
  ...
  },
  {
    ...
    sections: [
      { label: "목적", text: "정부 산하의 최정예 무력·교육 기관으로서 민간인의 절대적인 보호와 원령의 제령을 최우선 사명으로 삼는다." },
  ...
  },
  {
    ...
    sections: [
      { label: "목적", text: "사회를 어지럽히는 흉악한 술식 범죄자, 고전 탈주자, 그리고 통제 불능의 위험 원령 사용자를 그림자 속에서 찾아내어 처단한다." },
